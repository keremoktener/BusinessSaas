...
public class GlobalExceptionHandler {
     ...
     *
     */
    @ExceptionHandler(OrganizationManagementServiceException.class)
    @ResponseBody
    public ResponseEntity<ResponseDTO> handlerSatisException(OrganizationManagementServiceException satisException){
