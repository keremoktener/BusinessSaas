...
public class GlobalExceptionHandler {
     ...
     *
     */
    @ExceptionHandler(FileManagementServiceException.class)
    @ResponseBody
    public ResponseEntity<ResponseDTO> handlerSatisException(FileManagementServiceException satisException){
