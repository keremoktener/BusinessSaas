...
import com.businessapi.exception.NotificationException;
...
public class JwtTokenManager {
    @Value("${notifications.secret.secret-key}")
    String secretKey;
    @Value("${notifications.secret.issuer}")
    String issuer;
    ...
    public Optional<String> createToken(Long authId){
        ...
        try {
            ...
            throw new NotificationException(TOKEN_CREATION_FAILED);
    ...
    public Optional<Long> getAuthIdFromToken(String token){
        ...
        try {
            ...
            throw new NotificationException(TOKEN_FORMAT_NOT_ACCEPTABLE);
        } catch (JWTVerificationException e) {
            throw new NotificationException(TOKEN_VERIFY_FAILED);
        }
    }
}
